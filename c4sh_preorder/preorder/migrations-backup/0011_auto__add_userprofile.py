...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'preorder_userprofile', (
        ...
        db.send_create_signal(u'preorder', ['UserProfile'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table(u'preorder_userprofile')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'country': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'False'}),
