...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        #db.delete_column(u'preorder_userprofile', u'id')
        #Add fild 'UserProfile.id'
        db.add_column(u'preorder_userprofile', 'country',self.gf('django.db.models.fields.related.OneToOneField')(default='Serbia', to=orm['autrh.User']))


        # Changing field 'UserProfile.user'
        db.alter_column(u'preorder_userprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, primary_key=True, to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserProfile.user'
        db.alter_column(u'preorder_userprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
