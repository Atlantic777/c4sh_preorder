...
EVENT_NAME_SHORT = 'BalCCon2k14'

# Unix-friendly name of your event (lowercase, a-z0-9)
EVENT_NAME_UNIX = 'balccon2k14'

# Official name of your event
EVENT_NAME = 'BalCCon2k14 - Second Base'
...
EVENT_TIME_AND_LOCATION = "05.09.- 07.09.2014, Novi Sad"
...
EVENT_PAYMENT_PREFIX = "BalCCon2k14"
...
EVENT_PAYMENT_ACK_MAIL_TEXT = 	"English version below" + \
 ...
 "\n\nSee you on BalCCon2k14!\nBalCCon Orga"

# Footer note visible on all pages
EVENT_FOOTER_NOTE = "If you experience any difficulties with our presale, please contact the <a href='mailto:"+EVENT_CONTACT_MAILTO+"'>BalCCon2k14  Orga</a>."
...
EVENT_PASSBOOK_FROM = "September 5th, 2014" # Event from date, e.g. "27th December"
EVENT_PASSBOOK_TO = "September 7th, 2014"  # Event from date, e.g. "30th December"
EVENT_PASSBOOK_ORGANISATION = "BalCCon2k14" # Organisation, shown on lockscreen
...
EVENT_PASSBOOK_DESCRIPTION = "BalCCon2k14 Ticket" # Passbook ticket description
...
EVENT_PASSBOOK_LOGO_TEXT = "BalCCon2k14" # Passbook logo text
